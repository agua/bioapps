...
BEGIN {
    use_ok('Test::GT::Fuse');
    use_ok('Test::GT::Fuse::Zombies');
}
require_ok('Test::GT::Fuse');
require_ok('Test::GT::Fuse::Zombies');
...
my $object1 = new Test::GT::Fuse::Zombies(
    logfile     =>  $logfile,
	SHOWLOG     =>  $SHOWLOG,
	PRINTLOG    =>  $PRINTLOG
);
isa_ok($object1, "Test::GT::Fuse::Zombies", "object");
$object1->testGetZombies();

my $object2 = new Test::GT::Fuse(
    logfile     =>  $logfile,
	SHOWLOG     =>  $SHOWLOG,
	PRINTLOG    =>  $PRINTLOG
);
isa_ok($object2, "Test::GT::Fuse", "object2");

#### TESTS
$object2->testMount();
$object2->testMountSample();
