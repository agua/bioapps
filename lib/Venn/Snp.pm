...
#my $DEBUG = 1;
	...
	print "Venn::Snp::snpToVenn    executable: $executable\n" if $DEBUG;

	#### CHECK INPUTS
	print "Venn::Snp::snpToVenn    Venn::Snp::snpToVenn(outputdir, pileupfiles, label)\n" if $DEBUG;
...
#print "targetfile: $targetfile\n";
		...
		#print "Venn::Snp::snpToVenn    queryfile found: $queryfile\n";
		...
		print "Venn::Snp::snpToVenn    command:\n\n$command\n" if $DEBUG;
		...
		print "SNP::snpToVenn    checkfile: $checkfile\n" if $DEBUG;
	...
	print "Venn::Snp::snpToVenn    Running snpToSav.pl\n" if $DEBUG;
	$self->runJobs( $jobs, "snpToVenn-$queryindex-$targetindex" );	
	print "Venn::Snp::snpToVenn    Completed running snpToVenn.pl\n" if $DEBUG;
...
#my $DEBUG = 1;
	print "Venn::Snp::compare    Venn::Snp::compare(queryfile, targetfile, outputdir, querysuffix)\n" if $DEBUG;
	print "Venn::Snp::compare    queryfile: $queryfile\n" if $DEBUG;
	print "Venn::Snp::compare    targetfile: $targetfile\n" if $DEBUG;
	print "Venn::Snp::compare    outputdir: $outputdir\n" if $DEBUG;
	print "Venn::Snp::compare    prefix: $prefix\n" if $DEBUG;
	...
	print "Venn::Snp::compare    querylabel: $querylabel\n" if $DEBUG;
	print "Venn::Snp::compare    targetlabel: $targetlabel\n" if $DEBUG;
	...
	print "Venn::Snp::compare    queryonly: $queryonly\n" if $DEBUG;
	print "Venn::Snp::compare    targetonly: $targetonly\n" if $DEBUG;
	print "Venn::Snp::compare    both: $both\n" if $DEBUG;
	...
	#print "transcriptsVenn.pl    query_only_lines: \n";
	#print join "\n", @$query_only_lines;
	...
	#print "transcriptsVenn.pl    target_only_lines: \n";
	#print join "\n", @$target_only_lines;
	#print "transcriptsVenn.pl    \n";
	...
	#print "transcriptsVenn.pl    query_both_lines: \n";
	#print join "\n", @$query_both_lines;
	#print "transcriptsVenn.pl    \n";
	#
	#print "transcriptsVenn.pl    target_both_lines: \n";
	#print join "\n", @$target_both_lines;
	#print "transcriptsVenn.pl    \n";
...
#my $DEBUG = 1;
print "Venn::Snp::match    Venn::Snp::match(queryfile, targetfile)\n" if $DEBUG;
print "Venn::Snp::match    queryfile: $queryfile\n" if $DEBUG;
print "Venn::Snp::match    targetfile: $targetfile\n" if $DEBUG;
...
#next if $counter < 1475;
		...
		{
			#print "queryposition not defined for line: $_\n";
			next;
		}
		print "Venn::Snp::match    queryposition: $queryposition\n" if $DEBUG;
		my $match = 0;
...
#next if $i < 1475;
			...
			print "Venn::Snp::match    targetposition: $targetposition\n" if $DEBUG;
			print "Venn::Snp::match    MATCHED\n" if $targetposition eq $queryposition and $DEBUG;
...
sub AUTOLOAD {
	...
	print "++++ Venn::Snp::AUTOLOAD(self, newvalue)\n" if $DEBUG;
