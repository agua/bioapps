...
my $DEBUG = 1;
	print "Venn::Index::compare    Venn::Index::compare(queryfile, targetfile)\n" if $DEBUG;
	print "Venn::Index::compare    queryfile: $queryfile\n" if $DEBUG;
	print "Venn::Index::compare    targetfile: $targetfile\n" if $DEBUG;
	print "Venn::Index::compare    outputdir: $outputdir\n" if $DEBUG;
	print "Venn::Index::compare    querylabel: $querylabel\n" if $DEBUG;
	print "Venn::Index::compare    targetlabel: $targetlabel\n" if $DEBUG;
...
my $DEBUG = 1;
print "Venn::Index::match    Venn::Index::match(queryfile, targetfile)\n" if $DEBUG;
print "Venn::Index::match    queryfile: $queryfile\n" if $DEBUG;
print "Venn::Index::match    targetfile: $targetfile\n" if $DEBUG;
...
sub AUTOLOAD {
	...
	print "++++ Venn::Index::AUTOLOAD(self, newvalue)\n" if $DEBUG;
