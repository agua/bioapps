...
#my $DEBUG = 1;
	print "UCSCBin::setBinsByRange    UCSCBin::setBinsByRange(bins, rangefile)\n" if $DEBUG;

	print "UCSCBin::setBinsByRange    rangefile: $rangefile\n" if $DEBUG;
	...
	print "UCSCBin::setBinsByRange    readnumber: $readnumber\n" if $DEBUG;
	print "UCSCBin::setBinsByRange    hitstart: $hitstart\n" if $DEBUG;
	print "UCSCBin::setBinsByRange    hitstop: $hitstop\n" if $DEBUG;
...
#my $DEBUG = 1;
	...
	#print "UCSCBin::printRangefiles    UCSCBin::printRangefiles(inputdirs, chromosomes)\n" if $DEBUG;
	#print "UCSCBin::printRangefiles    inputdirs: @$inputdirs\n";

	#### EXECUTABLE
	my $executable		=	"$Bin/hitRange.pl";
	print "UCSCBin::printRangefiles    executable: $executable\n" if $DEBUG;
	...
	foreach my $inputdir ( @$inputdirs )
	{
		foreach my $chromosome ( @$chromosomes )
		{
			...
			print "UCSCBin::printRangefiles    bamfile: $bamfile\n" if $DEBUG;
...
sub getChromosomes {
	my $self		=	shift;
	my $inputdir	=	shift;
	#print "UCSCBin::getChromosomes    UCSCBin::getChromosomes(inputdir)\n";
	#print "UCSCBin::getChromosomes    inputdir: $inputdir\n";

	chdir($inputdir);
	my @chromosomes = <chr*>;
	#print "UCSCBin::getChromosomes    chromosomes: @chromosomes\n";
...
sub binCommand {
	...
	#print "UCSCBin::binCommand    UCSCBin::binCommand(bamfile, outputdir, binlevel, bin)\n";
	#print "UCSCBin::binCommand    bamfile: $bamfile\n";
	#print "UCSCBin::binCommand    outputdir: $outputdir\n";
	#print "UCSCBin::binCommand    binlevel: $binlevel\n";
	#print "UCSCBin::binCommand    bin: \n";
	#print Dumper $bin;
...
#print "UCSCBin::setBinfile    UCSCBin::setBinfile(bamfile, outputdir, binlevel, bin)\n";
#print "UCSCBin::setBinfile    bamfile: $bamfile\n";
#print "UCSCBin::setBinfile    outputdir: $outputdir\n";
#print "UCSCBin::setBinfile    binlevel: $binlevel\n";
#print "UCSCBin::setBinfile    bin:\n";
#print Dumper $bin;

	my ($filestub) = $bamfile =~ /([^\/]+)$/;
#print "UCSCBin::setBinfile    filestub: $filestub\n";
#exit;
...
#my $DEBUG = 1;	
	print "UCSCBin::createIndex    UCSCBin::createIndex(bamfile)\n" if $DEBUG;
	print "UCSCBin::createIndex    bamfile: $bamfile\n" if $DEBUG;
...
sub getChromosomeSize {
	...
	#print "$command\n";
	my $idxstats = `$command`;
	#print "UCSCBin::getChromosomeSize    idxstats: $idxstats\n";
...
sub getBins {
	...
	#print "UCSCBin::getBins    MAXSIZE: $MAXSIZE\n";
...
#my $DEBUG = 1;
#print "UCSCBin::getBinsBySize    UCSCBin::getBinsBySize(binsize, chromsome_size)\n" if $DEBUG;
#print "UCSCBin::getBinsBySize    binsize: $binsize\n" if $DEBUG;
#print "UCSCBin::getBinsBySize    chromosome_size: $chromosome_size\n" if $DEBUG;
...
#my $DEBUG = 1;
	#print "UCSCBin::unbin    UCSCBin::unbin(inputdirs, outputdir, filename, binlevel, suffix)\n" if $DEBUG;
	...
	foreach my $inputdir ( @$inputdirs )
	{
		...
		{	
			...
			print "UCSCBin::unbin    bamfile: $bamfile\n" if $DEBUG;
...
sub getExtendedBins {
	...
	my $binlevel	=	shift;
	#
	#print "UCSCBin::getInitialBins    UCSCBin::getInitialBins(binlevel)\n";
	#print "UCSCBin::getInitialBins    binlevel: $binlevel\n";
	#
	##### MINIMUM BIN SIZE
	#my $binsize = 2**17;
	#my $multiple = (4 - $binlevel);
	#print "UCSCBin::getInitialBins    BEFORE binsize: $binsize\n";
	#print "UCSCBin::getInitialBins    multiple: $multiple\n";
	#$binsize = $binsize << ($multiple * 3);
	#print "UCSCBin::getInitialBins    AFTER binsize: $binsize\n";
	#
	#my $numberbins = 2**($binlevel * 3);
	#print "UCSCBin::getInitialBins    numberbins: $numberbins\n";
	#
	#my $start = 0;
	#my $counter = 0;
	#while ( $counter < $binlevel )
	...
	#	$counter++;
	#}
	#print "UCSCBin::getInitialBins    start: $start\n";
	#
...
sub new
{
	...
	#print "UCSCBin::new    UCSCBin::new(arguments)\n";
#print "UCSCBin::new    arguments:\n";
...
#my $DEBUG = 1;	
	print "UCSCBin::initialise    UCSCBin::initialise(arguments)\n" if $DEBUG;
	#print "UCSCBin::initialise    arguments:\n" if $DEBUG;
