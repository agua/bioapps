...
#my $DEBUG = 1;
	print "Expression::TOPHAT::tophatBatchCommand    Expression::TOPHAT::tophatBatchCommand(outputfile, referencepath, splitfiles)\n" if $DEBUG;
	print "Expression::TOPHAT::tophatBatchCommand    outputdir: $outputdir\n" if $DEBUG;
	print "Expression::TOPHAT::tophatBatchCommand    referencepath: $referencepath\n" if $DEBUG;
	#print "Expression::TOPHAT::tophatBatchCommand    splitfiles:\n" if $DEBUG;
	...
	print "Expression::TOPHAT::tophatBatchCommand    cluster: $cluster\n" if $DEBUG;
	...
	print "Expression::TOPHAT::tophatBatchCommand    AFTER inputfile: $inputfile\n" if $DEBUG;
	print "Expression::TOPHAT::tophatBatchCommand    AFTER matefile: $matefile\n" if $DEBUG and defined $matefile;
	...
	{
		print "Expression::TOPHAT::tophatBatchCommand    USING tempdir: $tempdir\n" if $DEBUG;
...
$inputfile };
		...
		print "Expression::TOPHAT::tophatBatchCommand    command: $tophat_command\n" if $DEBUG;
...
exit;
	...
	{
		print "Expression::TOPHAT::tophatBatchCommand    NOT USING tempdir\n" if $DEBUG;
		my $tophat_command = qq{time $tophat/tophat \\
--num-threads $cpus \\\n};
...
#print "Expression::TOPHAT::new    arguments:\n";
