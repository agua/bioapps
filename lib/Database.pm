...
sub update_fulltext
{
	...
	#print "Success in adding new FULLTEXT '$fulltext': $success\n";
...
sub simple_queryarray
{
    ...
    #print "++++ simple_queryarray(dbh, query)\n";
    #print "Query: $query\n";
    ...
    {
        $result = $sth->fetchrow;
        #print "Database::simple_queryarray result: ";
        #print Dumper $result;
        #print "\n";
...
sub simple_queryhash
{
	...
	#print "Database::simple_queryhash\n";
	#print "$query\n";
    my $sth = $dbh->prepare($query);
	$sth->execute;
...
sub simple_queryhasharray
{
    ...
    #print "\n++++ simple_queryhasharray(dbh, query)\n";
    #print "Query: $query\n";
    ...
    #print "Hasharray after fetchrow_hashref:\n";
    #print Dumper $hasharray;

    #### DO SIMPLE HASH QUERY
    if ( not defined $hasharray )
    {
        #print "Hasharray not defined. Doing simple queryhash\n";
        my $result = Database::simple_queryhash($dbh, $query);
        #print "query hash result:\n";
        #print Dumper $result;
...
sub fields_tsvline
{
    ...
    #print "Util::fields_tsvline(fields, hash)\n";
    #print "Fields: $fields\n";
    #print "Hash:\n";
    #print Dumper $hash;
...
#    print "Change table: $change_table\n";
