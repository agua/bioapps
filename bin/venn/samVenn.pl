...
=head2
    ...
    ./samVenn::Sam.pl <--queryfile String> <--targetfile String>
...
my @arguments = @ARGV;
print "samVenn::Sam.pl    arguments: @arguments\n";
...
#### DEBUG
#print "samVenn::Sam.pl    outputdir: $outputdir\n";
#print "samVenn::Sam.pl    queryfile: $queryfile\n";
#print "samVenn::Sam.pl    targetfile: $targetfile\n";
#print "samVenn::Sam.pl    querylabel: $querylabel\n";
#print "samVenn::Sam.pl    targetlabel: $targetlabel\n";

my $venn = Venn::Sam->new(
	{
		queryfile => $queryfile,
...
print "samVenn::Sam.pl    Run time: $runtime\n";
print "samVenn::Sam.pl    Completed $0\n";
print "samVenn::Sam.pl    ";
