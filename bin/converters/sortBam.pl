...
#### DEBUG
print "sortBam.pl    inputfiles: $inputfiles\n" if $DEBUG;
print "sortBam.pl    outputfiles: $outputfiles\n" if defined $outputfiles and $DEBUG;
...
for ( my $i = 0; $i < @$infiles; $i++ )
{
	...
	print "Cluster::sortBam    sortedfile_stub: $sortedfile_stub\n" if $DEBUG;
	...
	print "sortBam.pl    command: $command\n" if $DEBUG;
