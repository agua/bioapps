...
#### DEBUG
#print "simpleVenn.pl    outputdir: $outputdir\n";
#print "simpleVenn.pl    queryfile: $queryfile\n";
#print "simpleVenn.pl    targetfile: $targetfile\n";
#print "simpleVenn.pl    querylabel: $querylabel\n";
#print "simpleVenn.pl    targetlabel: $targetlabel\n";
