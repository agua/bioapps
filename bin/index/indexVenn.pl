...
=head2
    ...
    ./indexVenn.pl <--queryfile String> <--targetfile String>
...
my @arguments = @ARGV;
print "indexVenn.pl    arguments: @arguments\n";
...
#### DEBUG
#print "indexVenn.pl    outputdir: $outputdir\n";
#print "indexVenn.pl    queryfile: $queryfile\n";
#print "indexVenn.pl    targetfile: $targetfile\n";
#print "indexVenn.pl    querylabel: $querylabel\n";
#print "indexVenn.pl    targetlabel: $targetlabel\n";
