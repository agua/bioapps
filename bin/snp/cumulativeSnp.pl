...
\
--stdout /ngs/bioinfo/syoung/base/pipeline/SRA/NA18507/SRP000239/sampled/200bp/autochr22/eland/cumulative-1/cumulativeSnp-stdout.txt
...
if ( defined $stdout )
{
	print "cumulativeSnp.pl    Printing STDOUT to stdoutfile:\n\n$stdout\n\n";
...
print "cumulativeSnp.pl    outputdir is a file: $outputdir\n" and exit if -f $outputdir;
File::Path::mkpath($outputdir) if not -d $outputdir;
print "cumulativeSnp.pl    Can't create output directory: $outputdir\n" and exit if not -d $outputdir;
...
#### DEBUG
print "cumulativeSnp.pl    inputdirs: $inputdirs\n";
print "cumulativeSnp.pl    outputdir: $outputdir\n";
print "cumulativeSnp.pl    cluster: $cluster\n";
print "cumulativeSnp.pl    params: $params\n" if defined $params;
...
print "cumulativeSnp.pl    samtools index: $samtools_index\n";
...
print "cumulativeSnp.pl    Doing cumulativeSnp()\n";
$snp->cumulativeSnp();

#### PRINT RUN TIME
my $runtime = Timer::runtime( $time, time() );
print "cumulativeSnp.pl    Run time: $runtime\n";
print "cumulativeSnp.pl    Completed $0\n";
print "cumulativeSnp.pl    ";
