...
sub qualbins
{
	...
	foreach my $inputfile ( @$files )
	{
		...
		#print "averageQualities.pl    statsfile: $statsfile\n";
		...
		my @lines = <FILE>;
		close(FILE);
		#print "averageQualities.pl    lines: @lines\n";
		...
		#print "averageQualities.pl    readcount: $readcount\n";
		#print "averageQualities.pl    avqual: $avqual\n";
		#print "averageQualities.pl    bins: $bins\n";
	...
	#print Dumper $hash;
		...
		#print "averageQualities.pl    totalreads: $totalreads\n";
		#print "averageQualities.pl    average_quality: $average_quality\n";
		#print "averageQualities.pl    readcount/totalreads: $readcount/$totalreads = ", $readcount/$totalreads, "\n";
		$total_average_quality += ($average_quality *($readcount/$totalreads)) if defined $average_quality;
		#print "averageQualities.pl    total average quality: $total_average_quality\n";
...
sub basequals
{
	...
	foreach my $inputfile ( @$files )
	{
		...
		#print "averageQualities.pl    basequalfile: $basequalfile\n";
		...
		#print "averageQualities.pl    hash:\n";
		#print Dumper $hash;
