...
sub fixed_width
{
	...
	print "fixedWidthFastq.pl    fixed_width(record, idlength, sequencelength)\n" if $DEBUG;
	print "fixedWidthFastq.pl    record: $record\n" if $DEBUG;
	print "fixedWidthFastq.pl    idlength: $idlength\n" if $DEBUG;
	print "fixedWidthFastq.pl    sequencelength: $sequencelength\n" if $DEBUG;
