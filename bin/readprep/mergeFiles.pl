...
foreach my $outputfile ( @outputfiles  )
{
	...
	#print "mergeFiles.pl    mergefiles->{$outputfile}:\n";	
	#print Dumper $mergefiles->{$outputfile};

	my $inputfiles = $mergefiles->{$outputfile};
	#print "mergeFiles.pl    inputfiles: @$inputfiles\n";
	...
	print "mergeFiles.pl    label: $label\n" if $DEBUG;
...
#print "mergeFiles.pl    commands: @$commands\n";
#exit;
