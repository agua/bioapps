...
my @arguments = @ARGV;
#print "CUFFLINKS.pl    arguments: @arguments\n";
...
print "CUFFLINKS.pl    CUFFLINKS: $cufflinks\n" if $DEBUG;
print "CUFFLINKS.pl    bowtie: $bowtie\n" if $DEBUG;
...
#### DEBUG
print "CUFFLINKS.pl    outputdir: $outputdir\n" if $DEBUG;
print "CUFFLINKS.pl    outputdir: $outputdir\n" if $DEBUG;
print "CUFFLINKS.pl    reference: $reference\n" if $DEBUG;
print "CUFFLINKS.pl    cluster: $cluster\n" if $DEBUG;
...
if ( defined $queue )
{
    ...
    print "CUFFLINKS.pl    queue: $queue\n" if $DEBUG;
    print "CUFFLINKS.pl    args: $args\n" if $DEBUG;
}
