...
my @arguments = @ARGV;
#print "CUFFCOMPARE.pl    arguments: @arguments\n";
...
my $cufflinks = $conf->getKey("applications:aquarius-8", 'CUFFCOMPARE');
...
print "CUFFCOMPARE.pl    CUFFCOMPARE: $cufflinks\n" if $DEBUG;
print "CUFFCOMPARE.pl    bowtie: $bowtie\n" if $DEBUG;
...
#### DEBUG
print "CUFFCOMPARE.pl    outputdir: $outputdir\n" if $DEBUG;
print "CUFFCOMPARE.pl    outputdir: $outputdir\n" if $DEBUG;
print "CUFFCOMPARE.pl    reference: $reference\n" if $DEBUG;
print "CUFFCOMPARE.pl    cluster: $cluster\n" if $DEBUG;
...
if ( defined $queue )
{
    ...
    print "CUFFCOMPARE.pl    queue: $queue\n" if $DEBUG;
    print "CUFFCOMPARE.pl    args: $args\n" if $DEBUG;
}
...
print "CUFFCOMPARE.pl    Doing run()\n" if $DEBUG;
$runCufflinks->run();
