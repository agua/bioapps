...
#            print "ELAND::checkcheckfiles    file is not defined in checklog line $counter: **$line**\n"
#                and exit if not defined $file;
#            print "ELAND::checkcheckfiles    filesize is not defined in checklog line $counter: **$line**\n"
