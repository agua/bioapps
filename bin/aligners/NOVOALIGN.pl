...
#print "NOVOALIGN.pl    Using novoalign version: $novoalign\n";
...
#print "NOVOALIGN.pl    samtools index: $samtools_index\n";
...
print "NOVOALIGN.pl    matefiles: $matefiles\n" if $DEBUG;
...
#    print "NOVOALIGN.pl    Paired files do not match. Exiting\n" and exit if not $mates_paired;
#}
