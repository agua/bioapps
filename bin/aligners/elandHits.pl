...
#
#	#my $DEBUG = 1;
#	print "loop.pl::set_parameter    loop.pl::set_parameter(arguments, parameter, value)\n" if $DEBUG;
#	print "loop.pl::set_parameter    parameter: $parameter\n" if $DEBUG;
#	print "loop.pl::set_parameter    value: $value\n" if $DEBUG;
#	
...
##my $DEBUG = 1;
#
#	print "loop.pl::fill_in    loop.pl::fill_in(arguments, value)\n" if $DEBUG;
#	print "loop.pl::fill_in    arguments:\n" if $DEBUG;
#	print join "\n", @$arguments if $DEBUG;
#	print "\n" if $DEBUG;
#	print "loop.pl::fill_in    pattern: $pattern\n" if $DEBUG;
#	print "loop.pl::fill_in    value: $value\n" if $DEBUG;
#	
#	print "loop.pl::fill_in    BEFORE REGEX arguments: @$arguments\n" if $DEBUG;
...
#
##my $DEBUG = 1;
#print "loop.pl::get_argument    loop.pl::get_argument(arguments, name)\n" if $DEBUG;
#print "loop.pl::get_argument    arguments:\n" if $DEBUG;
#print join "\n", @$arguments if $DEBUG;
#print "\n";
#print "loop.pl::get_argument    name: $name\n" if $DEBUG;
#
#	
#	my $argument;
#	for ( my $i = 0; $i < @$arguments; $i++ )
