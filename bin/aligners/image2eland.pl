...
my $squash = $conf->getKey("agua", 'SQUASH');
print "Goat pipeline: $goat_pipeline\n" if $DEBUG;
...
#{
#    print "File not found or empty: $squashfile1\n";
#    print "File not found or empty: $squashfile2\n";
#
#    my $squash_command = "$squash $eland_genome $referencefile";
#    print "Squash command:\n\n$squash_command\n\n";
#    my $squash_result = `$squash_command`;
#    print "\n";
#    if ( $squash_result =~ /Error/)
#    {
#        print "Error squashing reference file: $referencefile\n";
#        print "Please check the contents are in FASTA format.\n";
#        usage();
#    }
#}    
#
##### MOVE TO THE RUN DIRECTORY
#print "Moving to rundir: $rundir\n";
...
#}
#print "Finished running makefile.\n";
#
#print "Finished running makefile.\n\n";
#print "makefile output file: $makefile_out\n\n";
#print "makefile error file: $makefile_error\n\n";
#
#my $makefile_results = Util::contents($makefile_out);
#print "Makefile results:\n\n";
#print $makefile_results;
#print "Processing file path information...\n";
#
#
#my $makefile;
...
#else
#{
#    print "No makefile path in output file:\n\n$makefile_out\n\n";
#    print "Please also check error file:\n\n$makefile_error\n\n";
#}
#
...
#print "Make output file: $make_out\n\n";
#print "Make error file: $make_error\n\n";
#
