...
#### DEBUG
#print "replaceString.pl    inputfile: $inputfile\n";
#print "replaceString.pl    outputfile: $outputfile\n";
#print "replaceString.pl    query: $query\n";
#print "replaceString.pl    target: $target\n";
#print "replaceString.pl    global: $global\n";
