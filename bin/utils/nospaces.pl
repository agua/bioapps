...
my $DEBUG = 1;
	...
	print "nospaces.pl::nospaces    nospaces.pl::nospaces(inputfile, outputfile)\n" if $DEBUG;
	print "nospaces.pl::nospaces    inputfile: $inputfile\n" if $DEBUG;

	$outputfile = set_outputfile($inputfile) if not defined $outputfile;	
	print "nospaces.pl::nospaces    outputfile: $outputfile\n" if $DEBUG and defined $outputfile;
